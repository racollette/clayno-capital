...
export const FAQ_PROMPTS = [
  {
    id: 1,
    question: "What are the benefits of being in Clayno Capital?",
    answer: (
      <div className="flex flex-col gap-2">
        <p>
          Clayno Capital (CC) members enjoy several unique benefits, including:
        </p>
        <ul>
          <li>
    ...
    answer: (
      <div className="flex flex-col gap-2">
        ...
        <p>
          ...
          if they no longer hold the required assets.
        </p>
      </div>
    ),
  },
